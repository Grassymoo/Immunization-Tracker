...
<body>
    <header>
        ...
        <nav>
            <a href="http://localhost/home.php" class="active">Home</a>
    ...
    <div class="main-content">
        ...
        <h1>Keep Up To Date With Immunization Tracker!</h1>
        <p>Stay on top of your health with our new website:<br>
            track your vaccines, access detailed statistics, and explore many more features!</p>
    </div>
